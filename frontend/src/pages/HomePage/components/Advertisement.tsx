...
const Advertisement = () => {
  return (
    <section className="w-full py-20">
      <div className="bg-advertisement relative flex h-[350px] w-full max-w-full items-center overflow-hidden rounded-xl border border-black-10 bg-contain px-20 ">
